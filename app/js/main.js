  ...
  for (let i = 0; i < selectsLength; i++) {
    ...
    for (let j = 1; j < ll; j++) {
      ...
      c.addEventListener("click", function (canCreateDiscussions) {
        ...
        let sl;
        let dataUriLength;
        selector = this.parentNode.parentNode.getElementsByTagName("select")[0];
        sl = selector.length;
        ...
        for (; i < sl; i++) {
          if (selector.options[i].innerHTML == this.innerHTML) {
            ...
            readOnlyElements = this.parentNode.getElementsByClassName("same-as-selected");
...
if (accordionButtons && accordionContents) {
  accordionButtons.forEach((acc, index) => {
    ...
    acc.addEventListener("click", () => {
      accordionButtons.forEach(a => a.setAttribute("aria-expanded", "false"));
...
const comparisonCounter = document.querySelector(".header-basket-compare > span");
if (btnsToComparison) {
  let counter = 0;
...
if (mobileBasket) {
  ...
  document.addEventListener("click", e => {
    if (!e.target.closest(".basket-order") && !e.target.closest(".head-basket-block") && !e.target.closest(".icon") && !e.target.closest(".mob-basket")) {
...
if (searchBtnMobile) {
  ...
  headerSearchMobile.querySelector(".search-cross").addEventListener("click", () => {
...
if (videoPlay) {
  ...
  const playerListener = (player, playerFrame) => {
    player?.addEventListener("click", e => {
      if (e.target.closest(".modal-video-close-btn") || !e.target.closest(".modal-video-movie-wrap")) {
...
// card-product tabs
const cardProductSwitchers = document.querySelector(".nav-tabs")?.querySelectorAll(".nav-link");
const cardProductContents = document.querySelector(".tab-content")?.querySelectorAll(".tab-pane");
if (cardProductContents && cardProductContents) {
  cardProductSwitchers.forEach((switcher, index) => {
    switcher.addEventListener("click", e => {
      e.preventDefault();
      cardProductSwitchers.forEach(c => c.classList.remove("show", "active"));
...
framePlay && (player?.insertAdjacentHTML("beforeend", `
            <iframe width="560" height="315" src="" title="YouTube video player"
                frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>`), framePlay.forEach(e => {
  e.addEventListener("click", e => {
    e.preventDefault(), player.querySelector("iframe").setAttribute("src", "https://www.youtube.com/embed/LXb3EKWsInQ"), player.classList.add("show");
  });
}), player?.addEventListener("click", e => {
  let t = e.target;
  (t.closest(".player-close") || t !== player.querySelector("iframe")) && (player.querySelector("iframe").removeAttribute("src"), player.classList.remove("show"));
}));
...
const eSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".mySwiper", {
  spaceBetween: 10,
  slidesPerView: 4,
  freeMode: true,
...
if (brandsSlider) {
  const buttonNext = brandsSlider.parentElement.querySelector(".swiper-button-next");
  const buttonPrev = brandsSlider.parentElement.querySelector(".swiper-button-prev");
...
if (reviewsSlider) {
  const buttonNext = reviewsSlider.parentElement.querySelector(".reviews-arrow--next");
  const buttonPrev = reviewsSlider.parentElement.querySelector(".reviews-arrow--prev");
...
if (acticlesSlider) {
  const buttonNext = acticlesSlider.parentElement.querySelector(".articles-arrow--next");
  const buttonPrev = acticlesSlider.parentElement.querySelector(".articles-arrow--prev");
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](acticlesSlider, {
    slidesPerView: 4,
    spaceBetween: 20,
    loop: true,
    navigation: {
...
if (cardNestedSliders) {
  cardNestedSliders.forEach(slider => {
    const buttonNext = slider.parentElement.querySelector(".card-arrow--next");
    const buttonPrev = slider.parentElement.querySelector(".card-arrow--prev");
...
if (accessoriesSlider) {
  const buttonNext = accessoriesSlider.parentElement.querySelector(".swiper-button-next");
  const buttonPrev = accessoriesSlider.parentElement.querySelector(".swiper-button-prev");
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](accessoriesSlider, {
    slidesPerView: 3,
    spaceBetween: 20,
    navigation: {
      nextEl: buttonNext,
...
if (tabVideoSlider) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](tabVideoSlider, {
    loop: true,
    slidesPerView: 1,
    spaceBetween: 10,
    navigation: {
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".accessory-slide", {
    loop: false,
    slidesPerView: 4,
    spaceBetween: 10,
    breakpoints: {
  ...
  }), new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".similar-slide", {
    loop: false,
    slidesPerView: 4,
    spaceBetween: 10,
    breakpoints: {
...
if (cardsList.length) {
  cardsList.forEach(slider => {
    const buttonNext = slider.parentElement.querySelector(".cards-arrow--next");
    const buttonPrev = slider.parentElement.querySelector(".cards-arrow--prev");
    new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](slider, {
      slidesPerView: 4,
      spaceBetween: 20,
      navigation: {
...
const keysSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".keys-slide", {
  spaceBetween: 20,
  navigation: {
...
const slideDate = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".slide-date", {
  loop: false,
  spaceBetween: 10,
  slidesPerView: 6,
  freeMode: true,
...
new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".slide-images", {
  spaceBetween: 10,
  navigation: {
...
controlCheckboxes.forEach((e, t) => {
  e.addEventListener("change", () => {
    checkboxesContent?.forEach(e => e?.classList.remove("active")), checkboxesContent[t]?.classList.add("active");
  });
});
...
function isForm() {
  ...
  modals.forEach(modal => {
    modal.addEventListener("click", e => {
      const target = e.target;
      const conditions = !target.closest(".modal-content") || target.closest(".modal-close >img");
      if (conditions) {
...
if (catalogSortItems.length) {
  ...
  catalogSortItems.forEach(item => {
    item.addEventListener("click", e => {
      ...
      if (attr === 0) {
        sorted.push(...content.sort((a, b) => parseInt(a.getAttribute("data-sort")) - parseInt(b.getAttribute("data-sort"))));
      } else if (attr === 1) {
        sorted.push(...content.sort((a, b) => parseInt(b.getAttribute("data-sort")) - parseInt(a.getAttribute("data-sort"))));
      } else if (attr === 2) {
        sorted.push(...content.sort((a, b) => parseInt(b.getAttribute("data-sort")) > parseInt(a.getAttribute("data-sort"))));
      }
